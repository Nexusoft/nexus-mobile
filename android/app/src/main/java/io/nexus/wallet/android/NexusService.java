        ...
        _nexuscore = new NexusCore() {
            ...
            public void run() {
                ...
                MainActivity.startNexusCore(
                        ...
                        userCreds[0],
                        userCreds[1],
                        new String[]{"-manager=0", "-ssl=1" , "-apissl=1", "-apisslport=7080", "-apisslrequired=1", "-connect=lite3.nexenture.xyz", "-connect=lite4.nexenture.xyz", "-connect=node2.nexus.io", "-connect=circlingthesquares.com" , "-verbose=0", "-noterminateauth=1"}
                );
                super.run();
